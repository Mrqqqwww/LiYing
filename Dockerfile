...
# RMBG uses int8-quantized build: fp32 (176MB) OOMs the 512MB free instance
RUN mkdir -p /app/src/model     && curl -sfL -o /app/src/model/face_detection_yunet_2023mar.onnx        https://github.com/opencv/opencv_zoo/raw/main/models/face_detection_yunet/face_detection_yunet_2023mar.onnx     && curl -sfL -o /app/src/model/RMBG-1.4-model.onnx        https://huggingface.co/imgdesignart/rmbg-1-4-onnx/resolve/main/onnx/model_quantized.onnx     && curl -sfL -o /app/src/model/yolov8n-pose.onnx        https://huggingface.co/JONNYVERSE/yolov8n-pose/resolve/main/onnx/model.onnx
